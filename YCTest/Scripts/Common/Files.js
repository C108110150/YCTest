...
function checkImage(index) {
    var fileInput = document.getElementById('Pic_' + index);
    var uploadBtn = document.getElementById('uploadPic' + index);
    var deleteBtn = document.getElementById('uploadDelete' + index);
